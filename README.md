...
Đồ án môn **Trí tuệ nhân tạo — CS106.F31.CN2**, đề tài 5. **Nhóm 14**.
...
động từ `reports/results/*.json`, không gõ tay.
...
không nằm ở mô hình — một kết luận đáng viết hơn bất kỳ con số R² nào.
